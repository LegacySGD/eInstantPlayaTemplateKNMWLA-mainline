...
public class PlayaTemplateKNMWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PlayaTemplateKNMWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PlayaTemplateKNMWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PlayaTemplateKNMWLAIW/InitOutcome.xml").getDocumentElement();
